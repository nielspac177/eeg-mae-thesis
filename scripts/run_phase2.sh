...
step "pretrain d128_h4 (90ep)" "$PY" -m eeg_mae.cli.pretrain_mae --epochs 90 --enc-dim 128 --enc-heads 4 --snapshots 90
step "pretrain d256_h8 (90ep)" "$PY" -m eeg_mae.cli.pretrain_mae --epochs 90 --enc-dim 256 --enc-heads 8 --snapshots 90
step "pretrain d384_h6 (90ep)" "$PY" -m eeg_mae.cli.pretrain_mae --epochs 90 --enc-dim 384 --enc-heads 6 --snapshots 90
